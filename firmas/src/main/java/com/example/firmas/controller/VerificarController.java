...
public class VerificarController {
    ...
    public String verificarFirma(Model model, HttpSession session,
                                 @RequestParam("fileFirm") MultipartFile file) throws IOException, JSONException {
        ...
        if (certificado != null) {
            ...
            boolean firmaValida = Boolean.parseBoolean(restTemplateValidator.validarFirma(rutaArchivo));
